...
public abstract class AbstractEnchantedSmelterScreen<T extends AbstractEnchantedSmelterContainer>
    ...
    public void init() {
        ...
        this.addRenderableWidget(new ImageButton(this.leftPos + 20, this.height / 2 - 49, 20, 18, 0, 0, 19,
            ...
            this.leftPos = this.recipeBookComponent.updateScreenPosition(this.width, this.imageWidth);
            p_97863_.setPosition(this.leftPos + 20, this.height / 2 - 49);
        }));
    ...
    @Override
    public void render(@NotNull GuiGraphics p_97858_, int p_97859_, int p_97860_, float p_97861_) {
    ...
    @Override
    protected void renderBg(@NotNull GuiGraphics graphics, float p_97854_, int p_97855_, int p_97856_) {
