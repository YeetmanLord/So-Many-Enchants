...
public class Config {
    ...
    static {
        ...
        attackReach = new EnchantmentConfig(10, "Attack Reach", 3, true);
        blockReach = new EnchantmentConfig(10, "Block Reach", 3, true);
        catVision = new EnchantmentConfig(1, "Cat Vision", 1, true);
        camouflage = new EnchantmentConfig(1, "Camouflage", 1, true);
        critical = new EnchantmentConfig(5, "Critical", 5, true);
        cavernousStorage = new EnchantmentConfig(1, "Cavernous Storage", 1, true);
        doubleBreak = new EnchantmentConfig(5, "Double Break", 5, true);
        fastHopper = new EnchantmentConfig(1, "Fast Hopper", 1, true);
        flight = new EnchantmentConfig(3, "Flight", 3, true);
        ...
        stepAssist = new EnchantmentConfig(3, "Step Assist", 3, true);
