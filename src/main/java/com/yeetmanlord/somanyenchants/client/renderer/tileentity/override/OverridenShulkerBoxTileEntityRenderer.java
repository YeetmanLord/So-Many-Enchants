package com.yeetmanlord.somanyenchants.client.renderer.tileentity.override;
...
@OnlyIn(Dist.CLIENT)
public class OverridenShulkerBoxTileEntityRenderer extends TileEntityRenderer<OverridenShulkerBoxTileEntity> {
	private final ShulkerModel<?> model;

	@SuppressWarnings("rawtypes")
	public OverridenShulkerBoxTileEntityRenderer(TileEntityRendererDispatcher p_i226013_2_) {
		super(p_i226013_2_);
		this.model = new ShulkerModel();
	}

	public void render(OverridenShulkerBoxTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn,
		...
		if (tileEntityIn.hasWorld()) {
			...
			if (blockstate.getBlock() instanceof OverridenShulkerBoxBlock) {
				direction = blockstate.get(OverridenShulkerBoxBlock.FACING);
			}
		}
