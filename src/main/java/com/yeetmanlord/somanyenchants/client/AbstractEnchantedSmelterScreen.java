...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractEnchantedSmelterScreen<T extends AbstractEnchantedSmelterContainer> extends ContainerScreen<T>
		implements IRecipeShownListener
{
	...
	public AbstractEnchantedSmelterScreen(T screenContainer, AbstractRecipeBookGui recipeGuiIn, PlayerInventory inv, ITextComponent titleIn, ResourceLocation guiTextureIn) {
	...
	public void init()
	{
		...
		this.addButton(
				new ImageButton(this.guiLeft + 20, this.height / 2 - 49, 20, 18, 0, 0, 19, BUTTON_TEXTURE, (button) ->
				{
	...
	public boolean mouseClicked(double mouseX, double mouseY, int button)
	{
		...
		{
			return this.widthTooNarrowIn && this.recipeGui.isVisible() ? true
	...
	{
		return this.recipeGui.keyPressed(keyCode, scanCode, modifiers) ? false
	...
	protected boolean hasClickedOutside(double mouseX, double mouseY, int guiLeftIn, int guiTopIn, int mouseButton)
	{
		boolean flag = mouseX < (double) guiLeftIn || mouseY < (double) guiTopIn
				|| mouseX >= (double) (guiLeftIn + this.xSize) || mouseY >= (double) (guiTopIn + this.ySize);
		return this.recipeGui.func_195604_a(mouseX, mouseY, this.guiLeft, this.guiTop, this.xSize, this.ySize,
				mouseButton) && flag;
	}
