package com.yeetmanlord.somanyenchants.common.container.override.slots;
...
public class OverridenShulkerBoxSlot extends Slot {
	public OverridenShulkerBoxSlot(IInventory inventoryIn, int slotIndexIn, int xPosition, int yPosition) {
