package com.yeetmanlord.somanyenchants.common.tileentities.overrides;
...
public class OverridenShulkerBoxTileEntity extends LockableLootTileEntity
	...
	public OverridenShulkerBoxTileEntity(@Nullable DyeColor colorIn) {
	      super(TileEntityTypeInit.SHULKER_BOX.get());
	      this.color = colorIn;
	   }

	public OverridenShulkerBoxTileEntity() {
	      this((DyeColor)null);
	...
	public void tick() {
		...
		if (this.animationStatus == AnimationStatus.OPENING
	...
	public AxisAlignedBB getBoundingBox(BlockState state) {
		return this.getBoundingBox(state.get(OverridenShulkerBoxBlock.FACING));
	}
	...
	private void moveCollidedEntities() {
		...
		if (blockstate.getBlock() instanceof OverridenShulkerBoxBlock) {
			Direction direction = blockstate.get(OverridenShulkerBoxBlock.FACING);
	...
	public boolean canInsertItem(int index, ItemStack itemStackIn, @Nullable Direction direction) {
		return !(Block.getBlockFromItem(itemStackIn.getItem()) instanceof OverridenShulkerBoxBlock);
	}
	...
	public DyeColor getColor() {
		if (this.needsColorFromWorld) {
			this.color = OverridenShulkerBoxBlock.getColorFromBlock(this.getBlockState().getBlock());
	...
	protected Container createMenu(int id, PlayerInventory player) {
		return new OverridenShulkerBoxContainer(id, player, this);
	}
