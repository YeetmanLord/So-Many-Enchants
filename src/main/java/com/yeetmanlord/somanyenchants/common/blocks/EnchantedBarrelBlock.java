...
public class EnchantedBarrelBlock extends ContainerBlock {
	   ...
	   public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
	      if (worldIn.isRemote) {
	         ...
	         if (tileentity instanceof EnchantedBarrelTileEntity) {
	            player.openContainer((EnchantedBarrelTileEntity)tileentity);
	   ...
	   public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
	      TileEntity tileentity = worldIn.getTileEntity(pos);
	      if (tileentity instanceof EnchantedBarrelTileEntity) {
	         ((EnchantedBarrelTileEntity)tileentity).barrelTick();
	      }
	   ...
	   public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
	      if (stack.hasDisplayName()) {
	         TileEntity tileentity = worldIn.getTileEntity(pos);
	         if (tileentity instanceof EnchantedBarrelTileEntity) {
	            ((EnchantedBarrelTileEntity)tileentity).setCustomName(stack.getDisplayName());
	         }
	      }
