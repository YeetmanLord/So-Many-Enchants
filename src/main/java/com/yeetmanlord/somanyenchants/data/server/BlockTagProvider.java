...
public class BlockTagProvider extends BlockTagsProvider {
	...
	public static final class BlockTags {
		public static final Tag.Named<Block> PICKAXE_MINABLES = minecraftTag("mineable/pickaxe");
		public static final Tag.Named<Block> AXE_MINABLES = minecraftTag("mineable/axe");
		public static final Tag.Named<Block> SHULKER_BOXES = minecraftTag("shulker_boxes");

		public static Tag.Named<Block> minecraftTag(String path) {
			return net.minecraft.tags.BlockTags.createOptional(new ResourceLocation("minecraft", path));
		}
	}
