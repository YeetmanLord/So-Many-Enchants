...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234570_el_() {
      return LivingEntity.registerAttributes().createMutableAttribute(AttributeInit.ATTACK_DISTANCE.get()).createMutableAttribute(Attributes.ATTACK_DAMAGE, 1.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, (double)0.1F).createMutableAttribute(Attributes.ATTACK_SPEED).createMutableAttribute(Attributes.LUCK).createMutableAttribute(net.minecraftforge.common.ForgeMod.REACH_DISTANCE.get());
   }
...
public void livingTick() {
   ...
   public void blockUsingShield(LivingEntity entityIn) {
   ...
   public static Optional<Vector3d> func_242374_a(ServerWorld p_242374_0_, BlockPos p_242374_1_, float p_242374_2_, boolean p_242374_3_, boolean p_242374_4_) {
      ...
      if (block instanceof RespawnAnchorBlock && blockstate.get(RespawnAnchorBlock.CHARGES) > 0 && RespawnAnchorBlock.doesRespawnAnchorWork(p_242374_0_)) {
         ...
         return optional;
      } else if (blockstate.isBed(p_242374_0_, p_242374_1_, null) && BedBlock.doesBedWork(p_242374_0_)) {
