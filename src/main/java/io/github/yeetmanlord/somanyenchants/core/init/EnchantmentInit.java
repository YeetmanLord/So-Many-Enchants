package io.github.yeetmanlord.somanyenchants.core.init;

import io.github.yeetmanlord.somanyenchants.SoManyEnchants;
import io.github.yeetmanlord.somanyenchants.common.enchantments.EffectEnchantment;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.ArmorHeavyEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.ArmorReinforcementEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.ArmorTemperEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.CatVisionEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.FlightEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.HealthBoostEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.armor.StepAssistEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.blocks.CamouflageEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.blocks.CavernousStorageEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.blocks.ExtraExperienceSmelterEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.blocks.FastHopperEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.blocks.FastSmeltEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.blocks.FuelEfficientSmelterEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.tools.BlockReachEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.tools.DoubleBreakEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.tools.ReplantingEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.weapons.AttackReachEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.weapons.CriticalEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.weapons.FreezingEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.weapons.HeavyBladeEnchant;
import io.github.yeetmanlord.somanyenchants.common.enchantments.weapons.LightBladeEnchant;
